...
declare global {
  ...
  const isFirefox: typeof import('../utils/utils')['isFirefox']
  ...
  const settings: typeof import('../utils/helper')['settings']
  ...
  const useOthers: typeof import('../composables/useOthers')['useOthers']
