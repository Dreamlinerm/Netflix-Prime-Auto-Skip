...
program
	...
	.option("-v, --vite-chrome-config <path>", "Path to Vite Chrome config", "vite.chrome.config.ts")
	.option("-x, --vite-firefox-config <path>", "Path to Vite Firefox config", "vite.firefox.config.ts")
