...
const getDarwinPaths = (subdir: string) => {
	const home = homedir()
	const knownPaths = [resolve(home, "Applications", subdir), resolve("/Applications", subdir)]
	return knownPaths
}
...
const checkBinaryType = (path: string): BinaryType => {
	...
	if (platform === "linux") {
		try {
			const flatpakResult = execSync(`flatpak list --app | grep ${path}`).toString().trim()
...
export const Browsers: BrowserPaths[] = [
	...
	},
	{
		...
		path: {
			...
			linux: [...getLinuxPaths("brave-browser"), ...getLinuxPaths("com.brave.Browser")],
		},
	},
	{
		name: "Chrome",
		...
		path: {
			...
			linux: [...getLinuxPaths("google-chrome"), ...getLinuxPaths("google-chrome-stable")],
		},
	},
	{
		name: "Chrome Beta",
	...
	},
	{
		...
		path: {
			...
			linux: [...getLinuxPaths("chromium"), ...getLinuxPaths("org.chromium.Chromium")],
		},
	},
	{
		name: "Edge",
		...
		path: {
			...
			linux: [...getLinuxPaths("microsoft-edge"), ...getLinuxPaths("com.microsoft.Edge")],
		},
	},
	{
		name: "Sidekick",
	...
	},
	{
		...
		path: {
			...
			linux: [...getLinuxPaths("vivaldi-stable"), ...getLinuxPaths("com.vivaldi.Vivaldi")],
		},
	},
	{
		name: "Firefox",
		...
		path: {
			...
			linux: [...getLinuxPaths("firefox"), ...getLinuxPaths("org.mozilla.firefox")],
		},
	},
	{
		...
		path: {
			...
			linux: [...getLinuxPaths("firefox-nightly"), ...getLinuxPaths("org.mozilla.firefox-nightly")],
		},
	},
	{
		...
		path: {
			...
			linux: [...getLinuxPaths("firefox-dev"), ...getLinuxPaths("org.mozilla.firefox.dev")],
		},
	},
	{
		name: "Safari",
