		...
		<div class="flex h-full">
			...
			>
				<svg
					...
					viewBox="0 0 24 24"
					class="w-8 h-8 bg-transparent fill-primary-content text-primary-content flex justify-center items-center cursor-pointer"
				>
					<path
			...
			<a
				class="flex gap-2 items-center cursor-pointer mx-1.5"
				@click="openSettings"
			>
				<i-mdi-cog
					height="2.5rem"
