    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            if (video && !video.paused) {
                adTimeText = (_b = (_a = document
                    .querySelector("ad-badge-overlay")) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector(".ad-badge-overlay__content--time-display");
                if (adTimeText) {
                    adTime = parseAdTime(adTimeText === null || adTimeText === void 0 ? void 0 : adTimeText.textContent);
                    ...
                    lastAdTimeText = 0;
                continueText = document.querySelector("p.toast-notification__text[aria-hidden='true']");
                if (continueText === null || continueText === void 0 ? void 0 : continueText.checkVisibility()) {
                    continueText.remove();
                }
            }
            return [2 /*return*/];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            if (isDisney) {
                ...
                button = (_b = (_a = document
                    .evaluate("//span[contains(., 'Skip Intro')]", document, null, XPathResult.ANY_TYPE, null)) === null || _a === void 0 ? void 0 : _a.iterateNext()) === null || _b === void 0 ? void 0 : _b.parentElement;
            if (button &&
                !((_c = document.querySelector('[data-testid="icon-restart"]')) === null || _c === void 0 ? void 0 : _c.parentElement)) {
                button.click();
                console.log("Intro/Recap skipped", button);
                setTimeout(function () {
                    addSkippedTime(time, video === null || video === void 0 ? void 0 : video.currentTime, "IntroTimeSkipped");
                }, 600);
            }
            return [2 /*return*/];
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            if (isStarPlus)
                ...
                button = (_a = document.querySelector('[data-testid="icon-restart"]')) === null || _a === void 0 ? void 0 : _a.parentElement;
            else
                button = (_c = (_b = document
                    .evaluate("//span[contains(., 'Next Episode')]", document, null, XPathResult.ANY_TYPE, null)) === null || _b === void 0 ? void 0 : _b.iterateNext()) === null || _c === void 0 ? void 0 : _c.parentElement;
...
function Disney_addHomeButton() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            buttonDiv = (_a = document.querySelector('[data-testid="browser-action-button"]')) === null || _a === void 0 ? void 0 : _a.parentElement;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            ...
            if (button) {
                time = void 0;
                if (isDisney)
                    time = (_e = /\d+/.exec((_d = button === null || button === void 0 ? void 0 : button.textContent) !== null && _d !== void 0 ? _d : "")) === null || _e === void 0 ? void 0 : _e[0];
                if ((isHotstar &&
                    !((_f = document
                        .evaluate("//span[contains(., 'My Space')]", document, null, XPathResult.ANY_TYPE, null)) === null || _f === void 0 ? void 0 : _f.iterateNext())) ||
                    (time && lastAdTimeText != time)) {
                    video = Array.from(document.querySelectorAll("video")).find(function (v) {
                        return v.checkVisibility();
                    });
                    if (video) {
                        video.click();
...
var DisneySliderStyle = "pointer-events: auto;background: rgb(221, 221, 221);display: none;width:200px;";
var DisneySpeedStyle = "height:10px;min-width:40px;color:#f9f9f9;pointer-events: auto;position: relative;bottom: 8px;padding: 0 5px;";
            ...
            if (video) {
                ...
                if (!alreadySlider_1) {
                    ...
                    if (isDisney)
                        ...
                        position = (_d = (_c = (_b = (_a = document.querySelector(".icon-player-landscape")) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.parentElement) === null || _d === void 0 ? void 0 : _d.parentElement;
                    if (position)
                        createSlider(video, videoSpeed, position, DisneySliderStyle, DisneySpeedStyle);
                }
                else {
...
function Disney_selfAd(video, time) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (isDisney) {
                button = document.querySelector(".overlay_interstitials__promo_skip_button");
                if (button) {
                    button.click();
                    console.log("SelfAd skipped", button);
                    setTimeout(function () {
                        addSkippedTime(time, video === null || video === void 0 ? void 0 : video.currentTime, "DisneyAdTimeSkipped");
                    }, 600);
                }
            }
            return [2 /*return*/];
